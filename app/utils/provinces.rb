...
def provinces
	[
  		{ id_provincia: '15', provincia: 'A Coruña' },
		{ id_provincia: '3', provincia: 'Alacant/Alicante' },	
		...
		{ id_provincia: '48', provincia: 'Bizkaia/Vizcaya' },
		...
		{ id_provincia: '12', provincia: 'Castelló/Castellón' },
		...
		{ id_provincia: '20', provincia: 'Gipuzkoa/Guipúzkoa' },
		...
		{ id_provincia: '7', provincia: 'Illes Balears' },
		{ id_provincia: '23', provincia: 'Jaén' },
		{ id_provincia: '26', provincia: 'La Rioja' },
		{ id_provincia: '35', provincia: 'Las Palmas' },
		...
		{ id_provincia: '46', provincia: 'València/Valencia' },
